...
class TestHTMLNode(unittest.TestCase):
    def test_repr(self):
        node = HTMLNode(tag="div", value="Hello, World!", children=None, props={"class": "greeting", "id": "greeting1"})
        self.assertEqual(node.props_to_html(), 'class="greeting" id="greeting1"')
    ...
    def test_image(self):
        node = TextNode("This is an image", TextType.IMAGES, "https://example.com/image.png")
        html_node = text_node_to_html_node(node)
